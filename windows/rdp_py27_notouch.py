...
"""
# android clients <freerdp> can send UTF-8 chars from IME to sessions. This Qt4 client cannot do this.
...
class app_filter(QtGui.QApplication):
	...
	super(app_filter,self).__init__(argv)
...
# this is the remaining.
    ...
    if ':' in args[0]:
        ...
        ip, port = args[0], "3389"
# how to detect the input? custom input?
    #create application
#    app = QtGui.QApplication(sys.argv)
    app = app_filter(sys.argv)
#    app.setOverrideCursor(QtGui.QCursor(QtCore.Qt.WaitCursor))
# how about just create a little app without much intervention?
    # this is the thing. some custom fix here. do not use system input.
    #add qt4 reactor
    import qt4reactor
    qt4reactor.install()
